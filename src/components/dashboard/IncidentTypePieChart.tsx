...
export default function IncidentTypePieChart() {
  ...
  const data = [
    { label: "KTD", value: 40, color: "#EF4444", date: "2025-01-10" },
    { label: "KTC", value: 30, color: "#F59E0B", date: "2025-01-11" },
    { label: "KNC", value: 20, color: "#3B82F6", date: "2025-01-12" },
    { label: "KPCS", value: 10, color: "#10B981", date: "2025-01-13" },
    { label: "Sentinel", value: 5, color: "#8B5CF6", date: "2025-01-14" },
  ];
